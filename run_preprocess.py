...
def parse_args():
    ...
    parser.add_argument('--chest_x_ray_path', default='/home/than/physionet.org/files/mimic-cxr-jpg/2.0.0/files', help="Directory where chest x-ray image data is stored. This should point to the files folder from the MIMIC chest x-ray dataset.")
    parser.add_argument('--radiology_reports_path', default='/home/than/physionet.org/files/mimic-cxr-jpg/2.0.0/reports/files/', help="Directory radiology reports are stored. This should point to the files folder from the MIMIC radiology reports dataset.")
    parser.add_argument('--resolution', type=int, default=320, help="Resolution of the images to be saved in the hdf5 file.")
...
if __name__ == "__main__":
    ...
    if args.dataset_type == "mimic":
        ...
        Path(args.csv_out_path).parent.mkdir(parents=True, exist_ok=True)
